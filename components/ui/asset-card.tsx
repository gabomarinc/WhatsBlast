...
export const CryptoCard = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex w-full max-w-sm rounded-2xl overflow-hidden bg-white border border-secondary-200 shadow-lg",
        className
      )}
    >
      <div
      ...
      <div className="w-3/5 p-4 flex flex-col justify-between bg-white text-secondary-800">
        <div>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-secondary-500 bg-secondary-100 px-1.5 py-0.5 rounded-full">{leverage}X</span>
            </div>
          </div>
          <p className="text-sm text-secondary-500">{name} / {ticker}</p>
        </div>

        <div className="flex justify-between items-center mt-4">
          <div className="flex gap-2 text-secondary-400">
            <button className="hover:text-primary-500 transition-colors" aria-label="Add">
              <PlusIcon />
            </button>
            <button className="hover:text-primary-500 transition-colors" aria-label="More options">
              <DotsHorizontalIcon />
            </button>
          </div>
          <button className="text-secondary-400 hover:text-primary-500 transition-colors" aria-label="View chart">
            <ChartIcon />
          </button>
        </div>
      </div>
